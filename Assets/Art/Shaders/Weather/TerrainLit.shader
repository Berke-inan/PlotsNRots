// Derived from Unity URP 17.3.0; see Unity-LICENSE.md. Snow additions: Plots & Rots.
Shader "Plots & Rots/Terrain/Snow Lit"
{
    Properties
    {
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            #include "Assets/Art/Shaders/Weather/TerrainLitPasses.hlsl"
            ENDHLSL
        }
    ...
    Dependency "AddPassShader" = "Hidden/Plots & Rots/Terrain/Snow Lit (Add Pass)"
    Dependency "BaseMapShader" = "Hidden/Plots & Rots/Terrain/Snow Lit (Base Pass)"
